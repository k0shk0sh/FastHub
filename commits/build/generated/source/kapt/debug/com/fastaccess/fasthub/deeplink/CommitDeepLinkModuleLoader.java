...
public final class CommitDeepLinkModuleLoader implements Parser {
  public static final List<DeepLinkEntry> REGISTRY = Collections.unmodifiableList(Arrays.asList(
    ...
    new DeepLinkEntry("http://api.github.com/{login}/{repo}/pull/{number}/files", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    ...
    new DeepLinkEntry("http://github.com/{login}/{repo}/pull/{number}/files", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    ...
    new DeepLinkEntry("https://api.github.com/{login}/{repo}/pull/{number}/files", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    ...
    new DeepLinkEntry("https://github.com/{login}/{repo}/pull/{number}/files", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    new DeepLinkEntry("http://api.github.com/{login}/{repo}/commit/{oid}", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    new DeepLinkEntry("http://github.com/{login}/{repo}/commit/{oid}", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    new DeepLinkEntry("https://api.github.com/{login}/{repo}/commit/{oid}", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),
    new DeepLinkEntry("https://github.com/{login}/{repo}/commit/{oid}", DeepLinkEntry.Type.CLASS, CommitsListActivity.class, null),

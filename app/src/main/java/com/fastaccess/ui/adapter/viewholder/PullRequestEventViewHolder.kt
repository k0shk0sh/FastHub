    ...
    private fun renamedEvent(event: PullRequestTimelineQuery.AsRenamedTitleEvent) {
        event.actor()?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login())
                    .append(" ")
                    .append("renamed this from").append(" ").append(event.previousTitle())
    ...
    private fun headRefRestoredEvent(event: PullRequestTimelineQuery.AsHeadRefRestoredEvent) {
        event.actor()?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login())
                    .append(" ")
                    .append("head ref restored", BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.getThemeType())))
                    .append(" ")
    ...
    private fun refDeletedEvent(event: PullRequestTimelineQuery.AsHeadRefDeletedEvent) {
        event.actor()?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login())
                    .append(" ")
                    .append("head ref delete", BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.getThemeType())))
                    .append(" ")
    ...
    private fun deployedEvent(event: PullRequestTimelineQuery.AsDeployedEvent) {
        event.actor()?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login())
                    .append(" ")
                    .append("make a deployment", BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.getThemeType())))
                    .append(" ")

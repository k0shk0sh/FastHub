...
public class MainActivityTest {
    ...
    public void noUserTest() {
        assertFalse(testRule.getActivity().isLoggedIn());
        intended(hasComponent(LoginChooserActivity.class.getName()));
    }

    @Test
    public void onInitTest() {
        assertTrue(testRule.getActivity().isLoggedIn());
    ...
    @Test
    public void onSelectIssuesTabTest() {
        assertTrue(testRule.getActivity().isLoggedIn());
    ...
    @Test
    public void onSelectPullRequestsTabTest() {
        assertTrue(testRule.getActivity().isLoggedIn());

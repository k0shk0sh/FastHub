...
data class FeedModel(
    @SerializedName("id") @PrimaryKey var id: Long = 0L,
...
data class PayloadModel(
    ...
    @SerializedName("issue") var issue: FeedIssueModel? = null,
    @SerializedName("pull_request") var pullRequest: FeedIssueModel? = null,

...
class FeedsRepositoryProvider @Inject constructor(private val feedsDao: FeedDao,
    ...
    override fun getFeeds(login: String): Observable<List<FeedModel>> = feedsDao.getFeeds(login).toObservableDistinct()
    override fun getMainFeeds(login: String): Observable<List<FeedModel>> = feedsDao.getMainFeeds(login).toObservableDistinct()
...
interface FeedsRepository {
    ...
    fun getFeeds(login: String): Observable<List<FeedModel>>
    fun getMainFeeds(login: String): Observable<List<FeedModel>>
    fun deleteAll()
    fun deleteOldFeeds()
}
...
public class EmojiModel {
    ...
    /**
     * Constructor for the EmojiModel.
     *
     * @param description
    ...
    public boolean equals(Object other) {
        return !(other == null || !(other instanceof EmojiModel)) &&
                ((EmojiModel) other).getUnicode().equals(getUnicode());
    }
    ...
    /**
     * Returns the String representation of the EmojiModel object.<br>
     * <br>
     * Example:<br>
     * <code>EmojiModel {

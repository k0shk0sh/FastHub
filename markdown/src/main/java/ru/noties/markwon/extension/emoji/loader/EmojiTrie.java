...
public class EmojiTrie {
    ...
    public EmojiTrie(Collection<EmojiModel> emojis) {
    ...
    /**
     * Finds EmojiModel instance from emoji unicode
     *
     * @param unicode
     *         unicode of emoji to get
     * @return EmojiModel instance if unicode matches and emoji, null otherwise.
     */
    public EmojiModel getEmoji(String unicode) {
        Node tree = root;
    ...
    private class Node {
        ...
        private void setEmoji(EmojiModel emoji) {
            this.emoji = emoji;
        }

        private EmojiModel getEmoji() {
            return emoji;
        }
